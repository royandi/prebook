...
(function (e, t) {
    ...
    function p(e) {
        ...
        for (
            var o = r(10)
                ? document.body
                : null,
            n = e.offsetParent || null; n === o && e.nextElementSibling;
        ) 
            n = (e = e.nextElementSibling).offsetParent;
        var i = n && n.nodeName;
        return i && 'BODY' !== i && 'HTML' !== i
            ? -1 !== ['TH', 'TD', 'TABLE'].indexOf(n.nodeName) && 'static' === t(
                n,
                'position'
            )
                ? p(n)
    ...
    function m(e, t) {
        var o = 'x' === t
            ...
            n = 'Left' == o
                ? 'Right'
                : 'Bottom';
        return parseFloat(e['border' + o + 'Width']) + parseFloat(
            e['border' + n + 'Width']
        )
    }
    function h(e, t, o, n) {
        return ee(
            ...
            o['scroll' + e],
            r(10)
                ? parseInt(o['offset' + e]) + parseInt(n['margin' + (
                        'Height' === e
                            ? 'Top'
                            : 'Left'
                    )]) + parseInt(n['margin' + (
    ...
    function K(e, t, o) {
        ...
        if (!i) {
            var r = '`' + t + '`';
            console.warn(
                '`' + o + '` modifier is required by ' + r + ' modifier in order to work, be su' +
                're to include it before ' + r + '!'
            )
        }
        return i
    }
    ...
    var Q = Math.min,
        ...
        ge = function () {
            function t(o, n) {
                ...
                Object
                    .keys(le({}, t.Defaults.modifiers, r.modifiers))
                    .forEach(function (e) {
                        i
                            .options
                            .modifiers[e] = le(
        ...
        modifiers: {
                ...
                fn: function (e, t) {
                    ...
                    return p.forEach(function (s, d) {
                        ...
                        var a = e.offsets.popper,
                            ...
                            f = Z,
                            m = 'left' === n && f(a.right) > f(l.left) || 'right' === n && f(a.left) < f(
                                l.right
                            ) || 'top' === n && f(a.bottom) > f(l.top) || 'bottom' === n && f(a.top) < f(
                                l.bottom
                            ),
                            h = f(a.left) < f(o.left),
            ...
            computeStyle: {
                ...
                fn: function (e, t) {
                    ...
                    void 0 !== r && console.warn(
                        'WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will no' +
                        't be supported in future versions of Popper.js!'
                    );
                    var s,
                        d,
                        a = void 0 === r
            ...
            applyStyle: {
                ...
                fn: function (e) {
                    ...
                    e.arrowElement && Object
                        .keys(e.arrowStyles)
                        .length && V(e.arrowElement, e.arrowStyles),
                    e
                },
